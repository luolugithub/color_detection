...
background = Image.new('RGB', (1046, 1046), color='black').convert('RGBA')

foreground1 = Image.open("result/mask1Albite_transparent.png").convert('RGBA')
...
background.save("result/1result.png")
background.show()
